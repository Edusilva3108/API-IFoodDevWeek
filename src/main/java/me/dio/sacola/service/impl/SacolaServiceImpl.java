...
public class SacolaServiceImpl implements SacolaService {
    ...
    public Item incluirItemNaSacola(ItemDto ItemDto) {
        ...
        if (itensDaSacola.isEmpty()) {
            ...
            Restaurante restauranteAtualDoItemParaAdicionar = itemParaSerInserido.getProduto().getRestaurante();
            if (restauranteAtual.equals(restauranteAtualDoItemParaAdicionar)) {
                itensDaSacola.add(itemParaSerInserido);
            } else {
    ...
    public Sacola fecharSacola(Long id, int formaPagamento) {
        ...
        sacola.setFormaPagamento(tipoPagamento);
